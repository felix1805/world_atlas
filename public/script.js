...
function displayCountryInfo(countryData, container) {
  ...
  <p><strong>Capital:</strong> ${countryData.capital ? countryData.capital.join(', ') : 'Data not available'}</p>
  <p><strong>Region:</strong> ${countryData.region}</p>
  <p><strong>Pppulation:</strong> ${countryData.population.toLocaleString()}</p>
  <p><strong>Languages:</strong> ${languages}</strong></p>
  <p><strong>Currency:</strong> ${currencyName} (${currencySymbol})</p>
  <p><strong>Demonym:</strong> ${demonym}</p>
  <p><strong>Independant:</strong> ${countryData.independent ? 'Yes' : 'No'}</p>
